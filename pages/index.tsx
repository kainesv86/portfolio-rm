...
const Home: NextPage = () => {
        ...
        const translateSlider = useMemo(() => {
                return `translateX(-${width * currentPage}px)`;
        }, [currentPage, width]);

        const translatePage = useMemo(() => {
                return `translateX(${width * currentPage}px)`;
        }, [currentPage, width]);
        ...
        return (
                <div className="relative flex flex-col justify-between w-screen h-screen overflow-hidden transform font-nier text-zinc-50">
                        ...
                        <div className={`flex h-full w-fit duration-300`} style={{ transform: translateSlider }} translate="yes">
                                <div className="fixed top-0 left-0 h-full w-screen duration-[0ms]" style={{ transform: translatePage }}>
